...
import logo from "../Assets/BeyondChats_logo.png";
            ...
            <div>
              ...
              >
                <div className="m-2">
                  ...
                  <span className="ms-2"> BeyondChats</span>
                </div>
              ...
              <div className="m-4">
                ...
                <span className="ms-4">Telegram Features</span>
              </div>
            </div>
          </div>
        </div>
