...
const Chats = () => {
  const { chats, hasMore, loading, setPage } = useFetchChats();
        ...
        {chats.map((chat, index) => {
          ...
          const chatElement = (
            <div
              ...
              className={`d-flex align-items-center w-100 mt-3  rounded-4 p-2 ${
                theme === "light" ? "custom-white" : "custom-black"
              }`}
              key={uniqueChatKey}
            >
              ...
              <div className="custom-width-2 d-flex justify-content-between align-items-center">
                <div className="d-flex justify-content-between align-items-start flex-column">
                  ...
                  <h6 className="text-muted">
                    Hello {chat.creator.name || ""}! How can I assist you ?
                  </h6>
                </div>
